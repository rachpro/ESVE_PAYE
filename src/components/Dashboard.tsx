...
import { TrendingUp, Users, FileText, CreditCard, ReceiptText, Eye, Trash2, Download, Share2, Link, Mail, Check, X as CloseIcon, ChevronLeft, ChevronRight, PlusCircle } from 'lucide-react';
